...
export default function Show(){
    return ( 
    <section class="mx-auto w-screen relative watching-page font-poppins bg-form-bg" id="stream">
    
    <div className="pt-100px" >
            <ReactPlayer url="https://www.youtube.com/watch?v=mqqft2x_Aa4" controls width={"100%"} height={"969px"}>
